...
window.YDH_ENTITIES = {
  ...
  monsters: {
    ...
    moonStalker: {
      ...
      name: '달그림자 추적자',
      role: 'monster',
      sheet: 'assets/sprites/monster-moon-stalker-16dir.svg',
      defaultDirection: 8,
      grade: 'normal',
    ...
    inkWraith: {
      ...
      name: '잉크 망령',
      role: 'monster',
      sheet: 'assets/sprites/monster-ink-wraith-16dir.svg',
      defaultDirection: 8,
      grade: 'normal',
    ...
    mirrorWitch: {
      ...
      name: '반사 마녀',
      role: 'monster',
      sheet: 'assets/sprites/monster-mirror-witch-16dir.svg',
      defaultDirection: 8,
      grade: 'elite',
    ...
    abyssKnight: {
      ...
      name: '심연 기사',
      role: 'monster',
      sheet: 'assets/sprites/monster-abyss-knight-16dir.svg',
      defaultDirection: 8,
      grade: 'elite',
    ...
    blackMoonLord: {
      ...
      name: '검은 달의 군주',
      role: 'monster',
      sheet: 'assets/sprites/monster-black-moon-lord-16dir.svg',
      defaultDirection: 8,
      grade: 'boss',
  ...
  npcs: {
    ...
    ravenArchivist: {
      ...
      name: '까마귀 기록자',
      role: 'npc',
      sheet: 'assets/sprites/npc-raven-archivist-16dir.svg',
      defaultDirection: 12,
    ...
    moonPriestess: {
      ...
      name: '달무녀 세리아',
      role: 'npc',
      sheet: 'assets/sprites/npc-moon-priestess-16dir.svg',
      defaultDirection: 12,
    ...
    brokenSmith: {
      ...
      name: '부서진 대장장이 로한',
      role: 'npc',
      sheet: 'assets/sprites/npc-broken-smith-16dir.svg',
      defaultDirection: 12,
    ...
    silentPorter: {
      ...
      name: '침묵의 짐꾼',
      role: 'npc',
      sheet: 'assets/sprites/npc-silent-porter-16dir.svg',
      defaultDirection: 12,
