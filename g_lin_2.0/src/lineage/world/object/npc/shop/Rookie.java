...
public class Rookie extends ShopInstance {
	
	public Rookie(Npc npc){
		super(npc);
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp){
		if(pc.getLawful()<Lineage.NEUTRAL) {
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "ruky5"));
		} else {
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "ruky1"));
		}
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		if (action.equalsIgnoreCase("buy")) {
			...
			if (sell_list.size() > 0) {
				...
				pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "ruky4"));
			}
