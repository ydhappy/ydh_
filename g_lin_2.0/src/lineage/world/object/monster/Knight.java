...
public class Knight extends MonsterInstance {
	...
	public void toAiAttack(long time) {
	    if (!HP90 && getNowHp() <= getTotalHp() * 0.9) {
	        ChattingController.toChatting(this, "너희에게 지옥을 구경시켜 주마", Lineage.CHATTING_MODE_SHOUT);
	        HP90 = true;
	        return;
	    }
	    ...
	    if (!HP10 && getNowHp() <= getTotalHp() * 0.1) {
	        ChattingController.toChatting(this, "이곳이 너희들이 무덤이다!", Lineage.CHATTING_MODE_SHOUT);
	        HP10 = true;
	        return;
	    }
