...
public class Elder extends MonsterInstance {
	...
	public void toAiAttack(long time) {
	    ...
	    if (!HP40 && getNowHp() <= getTotalHp() * 0.8) {
	        ChattingController.toChatting(this, "이 계곡에 들어온 이상 절대 살아서 돌아갈 수 없을 것이다! 후하하하...", Lineage.CHATTING_MODE_SHOUT);
	        HP40 = true;
	        return;
	    }

	    if (!HP10 && getNowHp() <= getTotalHp() * 0.1) {
	        ChattingController.toChatting(this, "죽음을!", Lineage.CHATTING_MODE_SHOUT);
	        HP10 = true;
	        return;
	    }
