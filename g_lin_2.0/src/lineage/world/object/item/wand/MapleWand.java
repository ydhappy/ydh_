...
public class MapleWand extends ItemInstance {
	...
	public void toClick(Character cha, ClientBasePacket cbp){
		...
		if(objid==cha.getObjectId())
			...
			ChattingController.toChatting(cha, "단풍나무 막대는 자신에게 사용가능 합니다.", Lineage.CHATTING_MODE_MESSAGE);
			return;
		}
		
		((PcInstance)cha).setTempPoly(false);
		((PcInstance)cha).setTempPolyScroll(null);
