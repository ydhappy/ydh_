...
public class BuffRobotInstance4 extends RobotInstance {
	...
	public BuffRobotInstance4(int x, int y, int map, int heading, String name, String title, int lawful, int gfx, int gfxMode) {
		this.objectId = ServerDatabase.nextEtcObjId();
		mainObjectId = (int) this.objectId; // 주 NPC의 objectId를 저장
		this.x = x;
		this.y = y;
		this.map = map;
