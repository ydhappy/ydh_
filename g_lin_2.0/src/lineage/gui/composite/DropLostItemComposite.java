...
public class DropLostItemComposite extends Composite {
	 ...
	 * @param style
	 */
	public DropLostItemComposite(Composite parent, int style) {
		super(parent, style);
