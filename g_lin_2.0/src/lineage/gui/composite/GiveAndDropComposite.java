...
public class GiveAndDropComposite extends Composite {
	 ...
	 * @param style
	 */
	public GiveAndDropComposite(Composite parent, int style) {
		super(parent, style);
