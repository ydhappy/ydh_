(() => {
  ...
  function render() {
    ...
    section.innerHTML = `
      ...
      <h2>생성형 리소스 쇼케이스</h2>
      <p>클래스, NPC, 몬스터, 환경 타일/오브젝트 보강 이미지를 프로젝트 리소스 catalog에 등록했습니다. 현재 파일은 저장소 부담을 줄인 preview card이며, 원본 PNG/WebP는 binary 업로드 경로가 안정화되면 같은 경로 체계로 교체합니다.</p>
