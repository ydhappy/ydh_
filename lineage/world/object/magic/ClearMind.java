...
public class ClearMind extends Magic {
	...
	public void toBuffStart(object o) {
		if (o instanceof Character) {
			...
			o.toSender(S_Ext_BuffTime.clone(BasePacketPooling.getPool(S_Ext_BuffTime.class), S_Ext_BuffTime.BUFFID_745, getTime()));
		}
	}
	...
	public void toBuffEnd(object o) {
		...
		if (o instanceof Character) {
			...
			o.toSender(S_Ext_BuffTime.clone(BasePacketPooling.getPool(S_Ext_BuffTime.class), S_Ext_BuffTime.BUFFID_745, 0));
		}
	}
