...
public class BuffRobotInstance2 extends RobotInstance {
	...
	public BuffRobotInstance2(int x, int y, int map, int heading, String name, String title, int lawful, int gfx, int gfxMode) {
		...
		for (int e = 1; e < 5; ++e) {
			...
			o.setLawful(-12000);
			o.setGfx(16234);
			o.setName(String.format("%s%d", "켄말보조", e));
			o.setTitle("장사중");
			list.add(o);
		}
		for (int e = 1; e < 5; ++e) {
			...
			o.setLawful(-32767);
			o.setGfx(16234);
			o.setName(String.format("%s%d", "켄말버프", e));
			o.setTitle("장사중");
			list.add(o);
		}
		for (int e = 1; e < 5; ++e) {
			...
			o.setLawful(-32767);
			o.setGfx(16234);
			o.setName(String.format("%s%d", "헤이켄말", e));
			o.setTitle("장사중");
			list.add(o);
		}
		for (int e = 1; e < 6; ++e) {
			...
			o.setLawful(-32767);
			o.setGfx(16235);
			o.setName(String.format("%s%d", "버프켄말", e));
			o.setTitle("장사중");
			list.add(o);
		}
		// 멘트 목록.
		list_ment = new ArrayList<String>();
		list_ment.add(String.format("[켄말헤이샵] %d원 서비스 팍팍해드립니다.", Lineage.robot_auto_buff_aden2));
	...
	@Override
	public void toTradeOk(final Character cha) {
	    // 멘트치기
	    ChattingController.toChatting(this, "\f         \\\\f<f<서비스 어스한방~ 뾰로롱!", Lineage.CHATTING_MODE_NORMAL);
	    // 어스
	    IronSkin.init(this, SkillDatabase.find(19, 5), (int) cha.getObjectId());
