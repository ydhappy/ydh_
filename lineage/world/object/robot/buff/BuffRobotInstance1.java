...
public class BuffRobotInstance1 extends RobotInstance {
	...
	public BuffRobotInstance1(int x, int y, int map, int heading, String name, String title, int lawful, int gfx, int gfxMode) {
	...
	public void toTradeOk(Character cha){
	    // 멘트치기
	    ChattingController.toChatting(this, "\f         \\\\f<f<서비스로 블레스 한방~!", Lineage.CHATTING_MODE_NORMAL);
	    // 블래스
	    BlessWeapon.init(this, SkillDatabase.find(6, 7), cha.getObjectId(), true, true);
