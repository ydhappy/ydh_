...
public class KentcastleGuard extends SentryGuard {
	...
	public KentcastleGuard(Npc npc, Kingdom kingdom) {
		super(npc);
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		...
		pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "Kentcastle", null, list_html));
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		...
		if (action.equalsIgnoreCase("askwartime1")) {
			...
			if (kingdom.getWarDay() > 0) {
				...
				pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "Kentcastle1", null, list_html));
			} else {
				pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "Kentcastle2"));
			}
		}
	}
