...
public class Projection_Fight2 extends ItemInstance {

	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new Projection_Fight2();
		return item;
	}
	...
	public void toClick(Character cha, ClientBasePacket cbp){
		...
		if(BuffController.find(cha).find(BuffFight_03.class) != null) {
			ChattingController.toChatting(cha, "현자의 전투 강화 주문서가 현재 적용중입니다", Lineage.CHATTING_MODE_MESSAGE);
			return;
		}
		...
		if(s != null)
			...
			//적용
			BuffFight_03.onBuff(cha, SkillDatabase.find(403)); 
			// 아이템 수량 갱신
