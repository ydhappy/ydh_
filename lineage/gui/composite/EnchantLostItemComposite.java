...
public class EnchantLostItemComposite extends Composite {
	 ...
	 * @param style
	 */
	public EnchantLostItemComposite(Composite parent, int style) {
		super(parent, style);
