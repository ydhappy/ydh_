...
public class Ifrit extends MonsterInstance { 
	...
	public void toAiAttack(long time) {
	    if (!HP90 && getNowHp() <= getTotalHp() * 0.9) {
	        ChattingController.toChatting(this, "분..  분노가..모두..불태워주겠다!", Lineage.CHATTING_MODE_SHOUT);
	        HP90 = true;
	        return;
	    }

	    if (!HP30 && getNowHp() <= getTotalHp() * 0.8) {
	        ChattingController.toChatting(this, "뜨거운 고통이 너와 함께 하기를!", Lineage.CHATTING_MODE_SHOUT);
	        HP30 = true;
	        return;
	    }
