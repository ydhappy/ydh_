...
public class petComposite extends Composite {
	...
	private org.eclipse.swt.graphics.Color color_give = SWTResourceManager.getColor(255, 255, 255);
	 ...
	 * @param style
	 */
	public petComposite(Composite parent, int style) {
		super(parent, style);
	...
	public void toLog(String msg){
		...
		}else if (msg.contains("줍기")){
			chatting.setStyleRange( getHighlightStyle(log_now_pos, msg.length(), color_drop, SWT.BOLD) );
		}else{
			chatting.setStyleRange( getHighlightStyle(log_now_pos, msg.length(), color_give, SWT.BOLD) );
		}
