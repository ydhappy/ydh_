...
public class TradeComposite extends Composite {
	...
	private org.eclipse.swt.graphics.Color color_no_itme = SWTResourceManager.getColor(255, 0, 0);
	...
	public void toLog(String msg){
		...
		// 색상 입히기.
		if (msg.contains("<상대방 등록 물품 없음>")) {
			chatting.setStyleRange( getHighlightStyle(log_now_pos, msg.length(), color_no_itme, SWT.BOLD) );
		} else {
