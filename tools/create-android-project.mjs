...
async function main() {
  ...
  await writeFile(path.join(appDir, 'build.gradle'), `plugins { id 'com.android.application' }\n\nandroid {\n    namespace 'com.ydhappy.ydhchronicle'\n    compileSdk 35\n    defaultConfig { applicationId 'com.ydhappy.ydhchronicle'; minSdk 23; targetSdk 35; versionCode 3; versionName '0.3.0-online-mmorpg' }\n}\n`, 'utf8');
  ...
  console.log('Android online MMORPG project generated at android/app');
}
